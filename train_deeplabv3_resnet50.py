...
if __name__ == '__main__':
    ...
    train_dataset = SegmentationDataset(train_images, train_masks, classes, 320, True, True)
    train_dataloader = DataLoader(train_dataset, batch_size=8, shuffle=True, num_workers=8)

    val_dataset = SegmentationDataset(val_images, val_masks, classes, 320, True, True)
